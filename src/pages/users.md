...
* __M__
    ...
    * [monitoring-plugins](https://github.com/monitoring-plugins/monitoring-plugins/blob/1211edf2eaee9b26eca0505d0708629548e29f6e/plugins/check_curl.c#L60) — suite of monitoring plugins (formerly known as "nagios-plugins")
...
* __P__
    ...
    * [**PHP**](https://github.com/php/php-src/blob/fe5d4187fc46ac8c456d3ad5524b29fdf8ba4128/ext/uri/php_uri.c#L31) — extension "uri" of PHP >=8.5
...
* __T__
    ...
    * [TIN](http://bzr.tin.org/src/misc.c) — threaded NNTP and spool based UseNet newsreader
