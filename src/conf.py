...
BLOG_AUTHOR = "Sebastian Pipping"  # (translatable)
BLOG_TITLE = "uriparser"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://uriparser.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://uriparser.github.io/"
BLOG_EMAIL = "sebastian@pipping.org"
BLOG_DESCRIPTION = "uriparser is a strictly RFC 3986 compliant URI parsing and handling library written in C."  # (translatable)
